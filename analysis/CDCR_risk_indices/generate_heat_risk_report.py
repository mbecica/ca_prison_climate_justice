...
md_lines = [
    ...
    f'|:---|:---|:---|:---|',
    f'| Days over 90°F | Annual days with outdoor tmax ≥ 90°F (30-year averages, historic and mid-century) | 90°F is CDCR\'s own Stage I heat pathology activation threshold; used as the primary heat exposure metric by Skarha et al. (2023) and Ovienmhada et al. (2024) | Cal-Adapt, LOCA 2 (SSP3-7.0) |',
    f'| Hot nights | % of nights exceeding the 98th percentile of each tract\'s historical minimum temperature | Nighttime heat prevents physiological recovery from daytime exposure; relative threshold accounts for acclimatization differences across California climates; included in VCP heat hazard methodology | LCI VCP, LOCA 2 CA Hybrid |',
    f'| Air quality (AQI) | Normalized AQI score derived from ozone, PM2.5, and diesel exposure percentiles | Ozone and PM2.5 exacerbate respiratory stress during heat events; CalEnviroScreen 5.0 documents disproportionate AQI burden in communities surrounding prisons; included in VCP composite | CalEnviroScreen 5.0, 2025 |',
    f'',
    ...
    f'',
    f'Equal-weight average of five sub-indicators. All capture physiological susceptibility to heat stress.',
    f'',
    f'| Sub-indicator | Description | Research justification | Source |',
    f'|:---|:---|:---|:---|',
    ...
    f'|:---|:---|',
    f'| Capacity utilization (`capacity_percent_2025`) | Overcrowding is identified as a vulnerability factor by Hidden Hazards (2023), and is conceptually sound — crowding impairs ventilation and limits movement to cooler areas. Data are available for all 31 facilities (2025 annual average from CDCR TPOP reports). Excluded from scoring because CDCR-wide overcrowding is a systemic baseline condition rather than a facility-differentiating vulnerability: the majority of facilities exceed 100% capacity, and the variation across facilities reflects housing policy decisions rather than individual heat susceptibility. Retained as a descriptive column. |',
...
md_lines += [
    ...
    f'',
    f'Equal-weight average of five sub-indicators, each capturing physiological susceptibility to heat stress.',
    f'',
    f'| Sub-indicator | Variable | Source |',
    f'|:---|:---|:---|',
